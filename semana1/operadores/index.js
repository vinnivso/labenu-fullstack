...
console.log('O resto da divisao é:', numeroPar % 2)
...
//04
const number1 = Number(prompt('Digite o valor do primeiro Numero'))
const number2 = Number(prompt('Digite o valor do segundo Numero'))
