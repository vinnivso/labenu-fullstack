...
const fraseFinal = `O e-mail ${email} foi cadastrado com sucesso. Seja bem-vindo(a), ${nome}.`
...
const checkArray = arrayDeFrutas.indexOf("Abacaxi", 0)
console.log(checkArray, arrayDeFrutas.length)